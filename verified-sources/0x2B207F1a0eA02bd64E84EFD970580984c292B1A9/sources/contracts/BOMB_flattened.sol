...
contract BOMB is BOMBBase, NativeTransferable {
	...
	function _trySwapBack() public swapping {
		...
		try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(balance, 0, path, address(this), block.timestamp) {} catch {
			return;
		}
	}
